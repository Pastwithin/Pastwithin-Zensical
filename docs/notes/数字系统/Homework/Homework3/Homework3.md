...
<iframe src="../常微分方程light.html" style="display:block;width:calc(100% + 500px);min-width:1300px;margin-left:-200px;height:80vh;border:0;max-width:none;"></iframe>

<script>
(function(){
	const iframe = document.querySelector('iframe');
	if(!iframe) return;
	const darkSrc = '../Homework3_dark.html';
	const lightSrc = '../Homework3_light.html';
