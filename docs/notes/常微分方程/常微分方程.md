...
<iframe src="../常微分方程light.html" style="display:block;width:calc(100% + 500px);min-width:1300px;margin-left:-100px;height:80vh;border:0;max-width:none;"></iframe>

<script>
(function(){
	const iframe = document.querySelector('iframe');
	if(!iframe) return;
	const darkSrc = '../常微分方程_dark.html';
	const lightSrc = '../常微分方程_light.html';
