...
<iframe src="../Markdown基础语法_light.html" style="display:block;width:calc(100% + 500px);min-width:1300px;margin-left:-100px;height:80vh;border:0;max-width:none;"></iframe>

<script>
(function(){
	const iframe = document.querySelector('iframe');
	if(!iframe) return;
	const darkSrc = '../Markdown基础语法_dark.html';
	const lightSrc = '../Markdown基础语法_light.html';
